...
const embedSettings = {
  ...
  footertext: "By Abram Satria | Alfian Maulana",
};

const emojiSettings = {
  ERROR: "<a:alert:1252235583791693875>",
  SUCCESS: "<a:Verify:1252234899927203860>",
  disabled: "🔴",
  enabled: "🟢",
  cleared: "🧹",
  time: "⏲️",
...
const links = {
  ...
  DiscordServer: `1239619611021021244`,
  VoteURL: ``,
  Website: `https://kappurumedia.my.id`,
};
...
const slashSettings = {
  global: true,
  guildIDS: ["1239619611021021244"], // for slash command
};
